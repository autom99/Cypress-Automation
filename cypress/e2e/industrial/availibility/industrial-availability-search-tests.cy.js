import { launchWebsite, launchQAWebsite, selectIndustrialProductline } from "../../../utils/common";

describe("IndustrialAvailabilitySearch", () => {
  beforeEach(function () {
    // launchWebsite();
    launchQAWebsite()
  });

  it("Select_Industrial_Availability", () => {
    selectIndustrialProductline();
    //Click on Availibility from Sidebar
    cy.get('.mat-nav-list > [protractor-name="menu_0"] > .mat-list-item > .mat-list-item-content').click({ force: true });

  });

  /*
  it("Industrial_Availability_Clearallfilters_Search", () => {
  ...
  it("Industrial_Availability_LeaseSublet_Search", () => {
    //Click on Lease
  ...
  it("Industrial_Availability_LeaseDirect_Search", () => {
    //Click on Lease
    cy.get("#mat-checkbox-3-input").click({ force: true });
    //Click On Direct
  ...
  it("Industrial_Availability_Sale_Search", () => {
    //Click on Sale
  ...
  it("Industrial_Availability_City_Toronto_Search", () => {
    //type city name
  ...
  it("Industrial_Availability_Address_Search", () => {
    //type Address name
  ...
  it("Industrial_Availability_Vacancy_Unknown_Search", () => {
  ...
  it("Industrial_Availability_Vacancy_Occupied_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2").click();
    //Click On vacancy Dropdown
    cy.get("#mat-form-field-label-117").click({ force: true });
    //Select Occupied Check box
    cy.get("#mat-option-86 > .mat-option-pseudo-checkbox").click();
    //Click on Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Button+ icon
    cy.get(".search-column-button > .mat-button-wrapper > span").click({
  ...
  it("Industrial_Availability_Vacancy_Vacant_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2").click();
    //Click On vacancy Dropdown
    cy.get("#mat-form-field-label-117").click({ force: true });
    //Select Vacant Check box
    cy.get(".mat-option-text").contains(" Vacant ").click();
    //Click on Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Button+ icon
    cy.get(".search-column-button > .mat-button-wrapper > span").click({
  ...
  it("Industrial_Availability_UnitCondition_Improved_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2").click();
    //Click On unit Condition Dropdown
    cy.get("#mat-select-17").click();
  ...
  it("Industrial_Availability_UnitCondition_Model_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2").click();
    //Click On unit Condition Dropdown
    cy.get("#mat-select-17").click();
  ...
  it("Industrial_Availability_UnitCondition_Raw_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2").click();
    //Click On unit Condition Dropdown
    cy.get("#mat-select-17").click();
  ...
  it("Industrial_Availability_UnitCondition_Unknown_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2").click();
    //Click On unit Condition Dropdown
    cy.get("#mat-select-17").click();
  ...
  it("Industrial_Availability_Usage_Flex_Search", () => {
    //Click On Other Availability details tab
  ...
  it("Industrial_Availability_Usage_Industrial Unit_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on Usage Dropdown
    cy.get("#mat-select-18").click();
  ...
  it("Industrial_Availability_Usage_Lab_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on Usage Dropdown
    cy.get("#mat-select-18").click();
  ...
  it("Industrial_Availability_Usage_Land_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on Usage Dropdown
    cy.get("#mat-select-18").click();
  ...
  it("Industrial_Availability_Usage_Medical_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on Usage Dropdown
    cy.get("#mat-select-18").click();
  ...
  it("Industrial_Availability_Usage_Industrial_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on Usage Dropdown
    cy.get("#mat-select-18").click();
    //Click On Industrial Checkbox
    ...
    //Assert Usage Industrial
    cy.get("#k-grid0-r1c22").should("have.text", "Industrial");
    //Click on Usage Header
    cy.get(
      "#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner"
    ).click({ force: true });
    //Assert Usage Industrial after sorting
    cy.get("#k-grid0-r1c22").should("have.text", "Industrial");
    //Click on Usage Header
    cy.get(
      "#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner"
  ...
  it("Industrial_Availability_Usage_Industrial Suite_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on Usage Dropdown
    cy.get("#mat-select-18").click();
    //Click On Industrial Suite Checkbox
    ...
    //Assert Usage Industrial Suite
    cy.get("#k-grid0-r1c22").should("have.text", "Industrial Suite");
    //Click on Usage Header
    cy.get(
      "#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner"
    ).click({ force: true });
    //Assert Usage Industrial Suite after sorting
    cy.get("#k-grid0-r1c22").should("have.text", "Industrial Suite");
    //Click on Usage Header
    cy.get(
      "#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner"
  ...
  it("Industrial_Availability_Usage_Retail Unit_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on Usage Dropdown
    cy.get("#mat-select-18").click();
  ...
  it("Industrial_Availability_ListingStatus_Active_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
  ...
  it("Industrial_Availability_ListingStatus_Cancelled_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on Listing Status Dropdown
    cy.get("#mat-select-19").click();
  ...
  it("Industrial_Availability_ListingStatus_Expired_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on Listing Status Dropdown
    cy.get("#mat-select-19").click();
  ...
  it("Industrial_Availability_ListingStatus_Pending for Completion_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on Listing Status Dropdown
    cy.get("#mat-select-19").click();
  ...
  it("Industrial_Availability_UnitPhysicalStatus_Demolished_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
  ...
  it("Industrial_Availability_UnitPhysicalStatus_Design Build_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on UnitPhysicalStatus Dropdown
    cy.get("#mat-select-8").click();
  ...
  it("Industrial_Availability_UnitPhysicalStatus_Existing_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on UnitPhysicalStatus Dropdown
    cy.get("#mat-select-8").click();
  ...
  it("Industrial_Availability_UnitPhysicalStatus_Planned_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on UnitPhysicalStatus Dropdown
    cy.get("#mat-select-8").click();
  ...
  it("Industrial_Availability_UnitPhysicalStatus_Speculative Construction_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on UnitPhysicalStatus Dropdown
    cy.get("#mat-select-8").click();
  ...
  it("Industrial_Availability_UnitPhysicalStatus_Under Construction_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on UnitPhysicalStatus Dropdown
    cy.get("#mat-select-8").click();
  ...
  it("Industrial_Availability_UnitPhysicalStatus_Under renovation_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Click on UnitPhysicalStatus Dropdown
    cy.get("#mat-select-8").click();
  ...
  it("Industrial_Availability_ListingNotes_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
  ...
  it("Industrial_Availability_ListingReasearcherNotes_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Enter Text in ListingReasearcherNotes 
    cy.get('#mat-input-24').type("TEST RESEARCHER NOTES")
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
    ...
    cy.get('#k-grid0-r1c22').should("have.text", "TEST RESEARCHER NOTES");

  })
  it("Industrial_Availability_MLS#_Search", () => {
    //Click On Other Availability details tab
    cy.get("#mat-tab-label-0-2 > .mat-tab-label-content").click();
    //Enter Text in MLS# 
  ...
  it("Industrial_Availability_BuildingClass_A_Search", () => {
  ...
  it("Industrial_Availability_BuildingClass_AA_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //Click on BuildingClass Dropdown
    cy.get("#mat-select-9").click();
  ...
  it("Industrial_Availability_BuildingPhysicalStatus_Demolished_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //Click on BuildingPhysicalStatus Dropdown
    cy.get("#mat-select-10").click();
    //Click On Demolished Checkbox
    cy.get('#mat-option-121 > .mat-option-pseudo-checkbox').click();
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
  ...
  it("Industrial_Availability_BuildingPhysicalStatus_Existing _Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //Click on BuildingPhysicalStatus Dropdown
    cy.get("#mat-select-10").click();
    //Click On Existing  Checkbox
    cy.get('#mat-option-123 > .mat-option-pseudo-checkbox').click();
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
  ...
  it("Industrial_Availability_Tenancy_SingleTenant _Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //Click on Tenancy Dropdown
    cy.get("#mat-select-11").click();
    //Click On SingleTenant  Checkbox
    cy.get('#mat-option-129 > .mat-option-pseudo-checkbox').click();
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
  ...
  it("Industrial_Availability_Occupant_Competitive _Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //Click on Occupant Dropdown
    cy.get("#mat-select-12").click();
    //Click On Competitive Checkbox
    cy.get('#mat-option-132 > .mat-option-pseudo-checkbox').click();
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
  ...
  it("Industrial_Availability_PropertyCode_Converted_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //Click on PropertyCode Dropdown
    cy.get("#mat-select-13").click();
    //Click On Converted Checkbox
    cy.get('#mat-option-137 > .mat-option-pseudo-checkbox').click();
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
  ...
  it("Industrial_Availability_PropertyGroup_ Montreal Top 7 _Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //Click on PropertyGroup Dropdown
    cy.get("#mat-select-14").click();
    //Click On Montreal Top 7
    cy.get('#mat-option-143 > .mat-option-text').click();
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
  ...
  it("Industrial_Availability_Specification_BOMAGold_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    ...
    cy.get('#k-grid0-r1c22').should('include.text', ' BOMA: Gold ');


  });
  it("Industrial_Availability_PropertyNotes_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //Enter Text in PropertyNotes
    cy.get('#mat-input-5').type("Pre-Leasing")
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
    ...
    cy.get('#k-grid0-r1c22').should("include.text", "Pre-Leasing");
  ...
  it("Industrial_Availability_PropertyResearcherNotes_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
  ...
  it("Industrial_Availability_Legal Description_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //Enter Text in Legal Description 
    cy.get('#mat-input-7').type("TEST Legeal description")
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
    ...
    cy.get('#k-grid0-r1c22').should("include.text", "TEST Legeal description");
  ...
  it("Industrial_Availability_HeritageBuilding_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
  ...
  it("Industrial_Availability_NumberOfFloors_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //enter Value in From
  ...
  it("Industrial_Availability_IndustrialSize_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //enter Value in From
    ...
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
    //Click on  IndustrialSize  Checkbox
    cy.get(".mat-checkbox-label").contains(" Industrial Size ").click({ force: true });
    //Click on Apply Button
    cy.get('[style="float: right"] > .mat-raised-button').click({ force: true, });
    //Click on IndustrialSizes Header
    cy.get('#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner').click({ force: true });
    //Assert  IndustrialSize 
    cy.get('#k-grid0-r1c22').should("have.text", "500");
    //Click on IndustrialSize Header
    cy.get('#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner').click({ force: true });
    //Assert  IndustrialSize
    cy.get('#k-grid0-r1c22').should("have.text", "5,000");
  });

  it("Industrial_Availability_TotalBuildingSize_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //enter Value in From
  ...
  it("Industrial_Availability_YearBuilt_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //enter Value in From
  ...
  it("Industrial_Availability_Year Renovated_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //enter Value in From
  ...
  it("Industrial_Availability_ParkingRatio_Search", () => {
    //Click On PROPERTY CHARACTERISTICS tab
    cy.get('#mat-tab-label-0-3 > .mat-tab-label-content').click();
    //enter Value in From
  ...
  it("Industrial_Availability_Company/Contacts_InfoSource_Search", () => {
    ...
    cy.get('[style="float: right"] > .mat-raised-button').click({ force: true, });
    //Assert Info Source 
    cy.get('#k-grid0-r1c22').should("include.text", "Christain Forage-(Re/Max Legacy Realty Inc.)");
  ...
  it("Industrial_Availability_Company/Contacts_Lessee_Search", () => {
    //Click OnCompany/Contacts tab
    cy.get('#mat-tab-label-0-4 > .mat-tab-label-content').click();
    ...
    cy.get('[style="float: right"] > .mat-raised-button').click({ force: true, });
    //Assert Lessee
    cy.get('#k-grid0-r1c22').should("include.text", "Luke Slabczynski-(Jones Lang LaSalle Real Estate Services Inc.)");
  ...
  it("Industrial_Availability_Company/Contacts_ListingBroker_Search", () => {
    //Click OnCompany/Contacts tab
    cy.get('#mat-tab-label-0-4 > .mat-tab-label-content').click();
    //Enter text in ListingBroker
    cy.get('#mat-input-45').type('Lucie Dupontario')
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Assert ListingBroker
    cy.get('#k-grid0-r1c12').should("include.text", "Lucie Dupontario-(Barclay Street)");
  ...
  it("Industrial_Availability_Company/Contacts_Other_Search", () => {
    //Click OnCompany/Contacts tab
    cy.get('#mat-tab-label-0-4 > .mat-tab-label-content').click();
    //Enter text in Other
    cy.get('#mat-input-46').type('Babcock and Wilcox Power Generation Group Canada Corp.')
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
    ...
    cy.get('[style="float: right"] > .mat-raised-button').click({ force: true, });
    //Assert Other
    cy.get('#k-grid0-r1c22').should("include.text", "Babcock and Wilcox Power Generation Group Canada Corp.");
  ...
  it("Industrial_Availability_Company/Contacts_Owner_Search", () => {
    //Click OnCompany/Contacts tab
    cy.get('#mat-tab-label-0-4 > .mat-tab-label-content').click();
    //Enter text in Owner
    cy.get('#mat-input-47').type('Bosley Real Estate Ltd')
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Assert Owner
    cy.get('#k-grid0-r1c21').should("include.text", "Bosley Real Estate Ltd");
  ...
  it("Industrial_Availability_Company/Contacts_PropertyManagement_Search", () => {
    //Click OnCompany/Contacts tab
    cy.get('#mat-tab-label-0-4 > .mat-tab-label-content').click();
    //Enter text in PropertyManagement
    cy.get('#mat-input-48').type('Bentall Green Oak')
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
    ...
    cy.get('#k-grid0-r1c22').should("include.text", "Bentall Green Oak");
    //Click on  Property Management  Header
    cy.get('#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner').click({ force: true })
    //Assert  Property Management 
    cy.get('#k-grid0-r1c22').should("include.text", "Bentall Green Oak");
    //Click on  Property Management  Header
  ...
  it("Industrial_Availability_Company/Contacts_Purchaser_Search", () => {
    //Click OnCompany/Contacts tab
    cy.get('#mat-tab-label-0-4 > .mat-tab-label-content').click();
    //Enter text in Purchaser
    cy.get('#mat-input-49').type('G Purvis')
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
    ...
    cy.get('[style="float: right"] > .mat-raised-button').click({ force: true, });
    //Assert Purchaser 
    cy.get('#k-grid0-r1c22').should("include.text", "G Purvis");
  ...
  it("Industrial_Availability_Company/Contacts_SellingBroker_Search", () => {
    //Click OnCompany/Contacts tab
    cy.get('#mat-tab-label-0-4 > .mat-tab-label-content').click();
    //Enter text in SellingBroker
    cy.get('#mat-input-50').type('Rabcon Contractors Ltd.')
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
  ...
  it("Industrial_Availability_Company/Contacts_Sublessor_Search", () => {
    //Click OnCompany/Contacts tab
    cy.get('#mat-tab-label-0-4 > .mat-tab-label-content').click();
    //Enter text in Sublessor
    cy.get('#mat-input-51').type('Habco Beverage Systems Incorporated')
    //Click On Search button
    cy.get(".mat-raised-button").click({ force: true });
    //Click on Column + Button
    cy.get(".search-column-button").click({ force: true });
    ...
    cy.get('[style="float: right"] > .mat-raised-button').click({ force: true, });
    //Assert Sublessor
    cy.get('#k-grid0-r1c22').should("include.text", "Habco Beverage Systems Incorporated");
  ...
  it("Industrial_Availability_RecordDetails_CreatedDate_Search", () => {
    ...
    cy.get('#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner').click({ force: true })
    //Assert  Created Date 
    cy.get('#k-grid0-r1c22').should("include.text", " Mar 11, 2022", " Jan 12, 2022");
    //Click on  Created Date  Header
    cy.get('#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner').click({ force: true })
    //Assert  Created Date 
    cy.get('#k-grid0-r1c22').should("include.text", " Jan 4, 2023", " Jan 12, 2023");

  });

  it("Industrial_Availability_RecordDetails_LastUpdated_Search", () => {
    //Click On RecordDetails tab
    cy.get('#mat-tab-label-0-5 > .mat-tab-label-content').click();
    //Click On from 
    ...
    cy.get('#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner').click({ force: true })
    //Assert Last Updated 
    cy.get('#k-grid0-r1c22').should("include.text", "Mar 16, 2022", "Jan 12, 2022");
    //Click on Last Updated Header
    cy.get('#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner').click({ force: true })
    //Assert Last Updated 
  ...
  it("Industrial_Availability_RecordDetails_StatusUpdated_Search", () => {
    //Click On RecordDetails tab
    cy.get('#mat-tab-label-0-5 > .mat-tab-label-content').click();
    //Click On from 
    ...
    cy.get('#k-grid0-r1c22').should("include.text", "Mar 10, 2022", "Jan 12, 2022");
    //Click on Status Updated Header
    cy.get('#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner').click({ force: true })
    //Assert Status Updated 
    cy.get('#k-grid0-r1c22').should("include.text", "Jan 11, 2023", "Jan 12, 2023");
  ...
  it("Industrial_Availability_RecordDetails_LastVerified_Search", () => {
    //Click On RecordDetails tab
    cy.get('#mat-tab-label-0-5 > .mat-tab-label-content').click();
    //Click On from 
    ...
    cy.get('#k-grid0-r1c22').should("include.text", "May 18, 2022", "Jan 12, 2022");
    //Click on Last Verified Date Header
    cy.get('#k-grid0-r0c22 > .k-cell-inner > .k-link > .overflow-cell > .ngx-ellipsis-inner').click({ force: true })
    //Assert Last Verified Date 
  ...
  it("Industrial_Availability_UserCommunity_Alberta>Calgary_Search", () => {
    //Click On RecordDetails tab
    cy.get('#mat-tab-label-0-5 > .mat-tab-label-content').click();
